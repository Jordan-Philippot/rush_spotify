    ...
    return (
        <header class="main-header">
            <nav class="navbar navbar-expand-sm bg-black navbar-dark">
                <img src={Logo} class="d-inline-block navbar-brand logo" alt="Logo Spotify"></img>
                    ...
                    <ul class="navbar-nav">
                        ...
                        <li class="nav-item dropdown">
                            ...
                            <div class="dropdown-menu">
                                <a class="dropdown-item" href="/artists">Artiste</a>
                                <a class="dropdown-item" href="/Gender">Genre</a>
                                <a class="dropdown-item" href="/albums">Album</a>
                            </div>
                        </li>
                    </ul>
                </div>
